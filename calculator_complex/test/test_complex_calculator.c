...
void test_zero(void)
{
    ...
    TEST_ASSERT_EQUAL(SUCCESS, complex_prod(&c1, &c2, &result));
    TEST_ASSERT_EQUAL(0, result.real);
    TEST_ASSERT_EQUAL(0, result.imaginary);
...
void test_null(void){
    ...
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_sum(NULL, NULL, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_sum(&x, NULL, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_sum(NULL, &x, &result));

    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_diff(NULL, NULL, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_diff(NULL, &x, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_diff(&x, NULL, &result));

    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_prod(NULL, NULL, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_prod(NULL, &x, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_prod(&x, NULL, &result));
    
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_div(NULL, NULL, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_div(&x, NULL, &result));
    TEST_ASSERT_EQUAL(ERROR_NULL_PTR, complex_div(NULL, &x, &result));
